...
GhostClaw gives you the core functionality without that mess.
...
- Custom `ghostclaw` MCP server provides scheduling tools
...
**GhostClaw** - Originally forked from NanoClaw, a reference to Clawdbot (now OpenClaw).
